...
function ZensoriumTour() {
	...
	var cardioContentIndex = -1;
	
	var productTween;
	var productAndroidTween;
	var runningTween;
	...
	this.init = function () {
		...
		$('#toggleIOSBt').click(function () { toggleDevice(); return false; });
		$('#toggleAndroidBt').click(function () { toggleDevice(); return false; });
		
		$('.selection .ios').click(function () { toggleIOS(); return false; });
		$('.selection .android').click(function () { toggleAndroid(); return false; });
	...
	toggleIOS = function() {
		if(deviceMode == DEVICE_IOS) { return; }
		toggleDevice();
	}
	toggleAndroid = function() {
		if(deviceMode == DEVICE_ANDROID) { return; }
		toggleDevice();
	}
